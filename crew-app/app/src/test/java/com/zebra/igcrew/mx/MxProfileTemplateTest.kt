...
class MxProfileTemplateTest {
    ...
    fun `fills every placeholder`() {
        ...
        val filled = MxProfileTemplate.fill(
            template,
            mapOf(
                "ServiceIdentifier" to "content://com.zebra.mdna.els.provider/lockscreenaction/startauthentication",
                "CallerPackageName" to "com.zebra.igcrew",
            ),
        )
        ...
        assertEquals(
            ...
            <parm name="CallerPackageName" value="com.zebra.igcrew" />
            """.trimIndent(),
            filled,
        )
    }
