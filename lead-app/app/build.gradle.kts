...
android {
    namespace = "com.zebra.iglead"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.zebra.iglead"
...
// Builds the signed release APK, renames it to zebra-ig-lead-demo-<tag>.apk using the
...
val apkBaseName = "zebra-ig-lead-demo"
