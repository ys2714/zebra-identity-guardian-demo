...
android {
    namespace = "com.zebra.igcrew"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.zebra.igcrew"
...
// Builds the signed release APK, renames it to zebra-ig-crew-demo-<tag>.apk using the
...
val apkBaseName = "zebra-ig-crew-demo"
